  ...
  return (
    <section id="inicio" className="relative h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1492684223066-81342ee5ff30?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8&auto=format&fit=crop&w=2070&q=80')",
        }}
      >
      ...
      {/* Content */}
      <div className="relative h-full w-full max-w-screen-xl mx-auto px-4 flex flex-col justify-center items-start">
        <motion.div
